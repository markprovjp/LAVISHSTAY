                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        @if (Auth::user()?->hasPermission('quan_ly_nhan_vien') || Auth::user()?->hasPermission('quan_ly_khach_hang'))
                            <li class="sidebar-item pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if (request()->routeIs('admin.users.staffs*') || request()->routeIs('admin.users.customers*')) {{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }} @endif"
                                x-data="{ open: {{ request()->routeIs('admin.users.staffs*') || request()->routeIs('admin.users.customers*') ? 1 : 0 }} }">
                                <a class="block text-gray-800 dark:text-gray-100 truncate transition-all duration-200 @if (!request()->routeIs('admin.users.staffs*') && !request()->routeIs('admin.users.customers*')) {{ 'hover:text-gray-900 dark:hover:text-white' }} @else {{ 'text-violet-500' }} @endif"
                                    href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <svg class="shrink-0 fill-current transition-colors duration-200 @if (request()->routeIs('admin.users.staffs*') || request()->routeIs('admin.users.customers*')) {{ 'text-violet-500' }} @else {{ 'text-gray-400 dark:text-gray-500' }} @endif"
                                                width="20px" height="20px" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <span
                                                class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if (request()->routeIs('admin.users.staffs*') || request()->routeIs('admin.users.customers*')) {{ 'text-violet-500' }} @endif">Người
                                                dùng</span>
                                        </div>
                                        <!-- Icon -->
                                        <div
                                            class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                            <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 transition-transform duration-200 @if (request()->routeIs('admin.users.staffs*') || request()->routeIs('admin.users.customers*')) {{ 'rotate-180' }} @endif"
                                                :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                                <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                            </svg>
                                        </div>
                                ...
                                <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                    <ul class="pl-8 mt-1 overflow-hidden submenu-transition" x-show="open"
                                        ...
                                        @if (Auth::user()?->hasPermission('quan_ly_nhan_vien'))
                                            <li class="mb-1 last:mb-0">
                                                <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors duration-200 truncate @if (request()->routeIs('admin.users.staffs*')) {{ 'text-violet-500!' }} @endif"
                                        ...
                                        @if (Auth::user()?->hasPermission('quan_ly_khach_hang'))
                                            <li class="mb-1 last:mb-0">
                                                <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors duration-200 truncate @if (request()->routeIs('admin.users.customers*')) {{ 'text-violet-500!' }} @endif"
                        ...
                        @if (Auth::user()?->hasPermission('ho_tro_khach_hang'))
                            <li
                                class="sidebar-item pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if (request()->routeIs('admin.chat-support*')) {{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }} @endif">
                                <a class="block text-gray-800 dark:text-gray-100 truncate transition-all duration-200 @if (!request()->routeIs('admin.chat-support*')) {{ 'hover:text-gray-900 dark:hover:text-white' }} @else {{ 'text-violet-500' }} @endif"
                                    href="{{ route('admin.chat-support') }}">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 fill-current transition-colors duration-200 @if (request()->routeIs('admin.chat-support*')) {{ 'text-violet-500' }} @else {{ 'text-gray-400 dark:text-gray-500' }} @endif"
                                        ...
                                        <span
                                            class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if (request()->routeIs('admin.chat-support*')) {{ 'text-violet-500' }} @endif">Hỗ
                                            trợ khách hàng</span>
                                    </div>
                                </a>
                            </li>
                        ...
                        @if (Auth::user()?->hasPermission('danh_gia'))
                            <li
                                class="sidebar-item pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if (request()->routeIs('admin.reviews*')) {{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }} @endif">
                                <a class="block text-gray-800 dark:text-gray-100 truncate transition-all duration-200 @if (!request()->routeIs('admin.reviews*')) {{ 'hover:text-gray-900 dark:hover:text-white' }} @else {{ 'text-violet-500' }} @endif"
                                    href="{{ route('admin.reviews') }}">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 fill-current transition-colors duration-200 @if (request()->routeIs('admin.reviews*')) {{ 'text-violet-500' }} @else {{ 'text-gray-400 dark:text-gray-500' }} @endif"
                                            width="20px" height="20px" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-enumerator2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                                        </svg>
                                        <span
                                            class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if (request()->routeIs('admin.reviews*')) {{ 'text-violet-500' }} @endif">Đánh
                                            giá</span>
                                    </div>
                                </a>
                            </li>
                        ...
                        @if (Auth::user()?->hasPermission('cau_hoi_thuong_gap'))
                            <li
                                class="sidebar-item pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if (request()->routeIs('admin.faqs*')) {{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }} @endif">
                                <a class="block text-gray-800 dark:text-gray-100 truncate transition-all duration-200 @if (!request()->routeIs('admin.fa施加权faqs*')) {{ 'hover:text-gray-900 dark:hover:text-white' }} @else {{ 'text-violet-500' }} @endif"
                                    href="{{ route('admin.faqs') }}">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 fill-current transition-colors duration-200 @if (request()->routeIs('admin.faqs*')) {{ 'text-violet-500' }} @else {{ 'text-gray-400 dark:text-gray-500' }} @endif"
                                            width="16" height="08:12 PM +07 on Tuesday, August 19, 2025"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor">
                                            -path stroke-linecap="round" stroke-linejoin="round"
                                            d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.(codecatalyst375 0 0 1 .75 0Zm0
                                            0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125
                                            0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375m-13.5 3.01c0 1.6
                                            1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14
                                            1.14 0 0 1 .778-.332 48.294 48.294 0 0 0 5.83-.498c1.585-.233 2.708-1.626
                                            2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12
                                            3c-2.392 personally0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25
                                            6.741v6.018Z" />
                                        </svg>
                                        <span
                                            class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 @if (request()->routeIs('admin.faqs*')) {{ 'text-violet-500' }} @endif">Câu
                                            hỏi thường gặp</span>
                                    </div>
                                </a>
                            </li>
                                    ...
                                    <ul class="pl-9 mt-1 overflow-hidden submenu-transition" x-show="open"
                                        ...
                                        <li class="mb-1 last:mb-0">
                                            <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors duration-200 truncate @if (request()->routeIs('admin.payment.index*')) {{ 'text-violet-500!' }} @endif"
                                                ...
                                                <span
                                                    class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Đang
                                                    giao dịch</span>
                                            </a>
                                        </li>
                                        <li class="mb-1 last:mb-0">
                                            <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors duration-200 truncate @if (request()->routeIs('admin.payment.index*')) {{ 'text-violet-500!' }} @endif"
                                                ...
                                                <span
                                                    class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Quản
                                                    lý</span>
                                            </a>
                                        </li>
                                    </ul>

<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex justify-between items-center">
            <div class="mb-8">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Thông tin khách hàng</h1>
                        ...
                        <div class="ml-3 mr-8">
                            ...
                            <div class="text-sm text-green-600">
                                @if (session('new_password'))
                                    Mật khẩu mới đã được gửi tới email: <span
                                        class="font-semibold">{{ $user->email }}</span>
                                @else
                                    {{ session('success') }}
                                @endif
                            </div>
                    ...
                    <div class="lg:col-span-12 w-full max-w-none">
                        <div
                            ...
                            <div class="flex items-end justify-between mb-4">
                                ...
                                <a href="{{ route('admin.users.customers.edit', $user->id) }}">
                                    <button
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                                            ...
                                            <span
                                                class="text-sm text-gray-900 dark:text-gray-100">{{ $user->identity_code ?? 'Chưa cung cấp' }}</span>
                                        </div>
                                    </div>
                                    <div>
                                        <label
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            <div class="p-4 border border-gray-200 dark:border-gray-600 rounded-md">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-4">Đặt lại mật khẩu
                                    khách hàng</h4>
                                <form action="{{ route('admin.users.customers.reset-password', $user->id) }}"
                                    method="POST"

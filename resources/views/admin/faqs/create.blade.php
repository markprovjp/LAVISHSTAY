                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="question_vi" id="question_vi" rows="3"
                                        ...
                                        placeholder="Nhập câu hỏi bằng tiếng Việt..." required>{{ old('question_vi') }}</textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="answer_vi" id="answer_vi" rows="5"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        placeholder="Nhập câu trả lời bằng tiếng Việt..." required>{{ old('answer_vi') }}</textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="answer_en" id="answer_en" rows="5"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        placeholder="Enter answer in English..." required>{{ old('answer_en') }}</textarea>
                                </div>

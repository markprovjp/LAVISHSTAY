...
export const sampleRooms: Room[] = [
    {
        ...
        mainAmenities: ["view biển", "ban công riêng", "wifi miễn phí", "không hút thuốc"],
        discount: 20,
        roomType: "premium",
        rating: 9.4,
        maxGuests: 2,
        ...
        mainAmenities: ["phòng khách riêng", "quản gia 24/7", "view thành phố", "ban công panorama"],
        ...
        mainAmenities: ["lounge riêng", "dịch vụ quản gia", "view biển", "minibar cao cấp"],
        roomType: "theLevel",
        rating: 9.5,
        maxGuests: 2,
        ...
        priceVND: 10500000,
        size: 95,
        view: "Tầm nhìn panorama", bedType: {
            default: "Giường đôi",
            options: ["Giường đôi", "2 giường đơn"]
        ...
        mainAmenities: ["view panorama", "lounge riêng", "dịch vụ quản gia", "cityView"],
        roomType: "theLevel",
        rating: 9.5,
        maxGuests: 2,

...
const HotelActivities: React.FC = () => {
  ...
  return (
    <div className="relative py-6 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br "></div>      <div className="absolute top-10 left-20 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 relative">        {/* Header */}

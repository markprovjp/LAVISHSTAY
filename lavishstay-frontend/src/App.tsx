              ...
              <Route path="/reception/*" element={
                <ReceptionLayout>
                  <Routes>
                    ...
                    <Route path="rooms/today" element={<RoomManagementToday />} />
                    <Route path="rooms/checkin" element={<CheckInManagement />} />
                    <Route path="rooms/checkout" element={<CheckOutManagement />} />
                    <Route path="rooms/maintenance" element={<MaintenanceManagement />} />
                  </Routes>
                </ReceptionLayout>
              } />

<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Form -->
        <form action="{{ route('admin.rooms.store', $roomType->room_type_id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirmSubmit()">
            @csrf
 ...
 @error('name') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <select name="floor_id" class="border w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 
 ...
 @error('floor_id') border-red-500 @enderror">
                                        @foreach(\App\Models\Floor::all() as $floor)
                                            <option value="{{ $floor->floor_id }}" {{ old('floor_id') == $floor->floor_id ? 'selected' : '' }}>
 ...
 w-full @error('bed_type_fixed') border-red-500 @enderror">
                                        @foreach(\App\Models\BedType::active()->get() as $bedType)
                                            <option value="{{ $bedType->id }}" {{ old('bed_type_fixed') == $bedType->id ? 'selected' : '' }}>
                                                {{ $bedType->type_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="status" class="border w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 

    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                @if (auth()->user()?->hasPermission('create_staffs'))
                            ...
                            <thead>
                                <tr class="bg-gray-50 dark:bg-gray-700">
                                    ...
                                    <th
                                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Join Date</th>
                                        @if (auth()->user()?->hasPermission('view_staffs_actions'))
                                            <th
                                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                                Actions</th>
                                        @endif
                                                ...
                                                <div class="relative inline-block text-left">
                                                    ...
                                                    <div id="dropdown-menu-{{ $user->id }}"
                                                        ...
                                                        <div class="py-1 z-500" role="menu">
                                                            ...
                                                            @if (auth()->user()?->hasPermission('view_staffs_show'))
                                                            ...
                                                            <!-- Delete -->
                                                            @if (auth()->user()?->hasPermission('delete_staffs'))
                                                                <button

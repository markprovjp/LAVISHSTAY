                                    ...
                                    <div class="text-center md:text-left">
                                        <div class="relative">
                                            @if ($user->profile_photo_url)
                                                <img class="w-20 h-20 mx-auto md:mx-0 rounded-full object-cover border-2 border-gray-200 dark:border-gray-600 shadow-sm absolute"
                                                    src="{{ $user->profile_photo_url }}" alt="{{ $user->name }}" />
                                            @else
                                                <div
                                                    class="w-24 h-24 mx-auto md:mx-0 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center border-2 border-gray-200 dark:border-gray-600 shadow-sm absolute">
                                                    <span
                                                        class="text-white font-bold text-2xl">{{ strtoupper(substr($user->name, 0, 2)) }}</span>
                                                </div>
                                            @endif
                                            <h2
                                                class="text-lg font-bold text-gray-900 dark:text-gray-100 mt-3 absolute">
                                                {{ $user->name }}</h2>
                                            <span
                                        ...
                                        @elseif($user->role === 'receptionist') bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300
                                        @elseif($user->role === 'guest') bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300

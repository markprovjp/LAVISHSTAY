    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Create New Bed Type</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Add a new Bed Type to your inventory</p>
            </div>
            ...
            <div class="">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <form action="{{ route('admin.services.beds.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="px-6 py-4 border-t mt-5 rounded-b-lg">
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <button type="submit" class="btn bg-violet-500 hover:bg-violet-600 text-white">Create Bed Type</button>
                                </div>
                            </div>
                        </form>
                    </div>

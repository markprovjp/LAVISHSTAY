                        ...
                        <form action="{{ route('admin.room-types.update', $roomType->room_type_id) }}" method="POST" id="roomTypeForm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="room_area" id="room_area" value="{{ old('room_area', $roomType->room_area) }}"
                                        class="form-input w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="view" id="view" value="{{ old('view', $roomType->view) }}"
                                        class="form-input w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="rating" id="rating" value="{{ old('rating', $roomType->rating) }}"
                                        class="form-input w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="max_guests" id="max_guests" value="{{ old('max_guests', $roomType->max_guests) }}"
                                        class="form-input w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white"

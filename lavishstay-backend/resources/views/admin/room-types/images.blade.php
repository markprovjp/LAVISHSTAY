                            ...
                            <div class="p-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <button onclick="editImage({{ $image->image_id }})"
                                            class="flex-1 cursor-pointer min-w-0 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-lg transition-colors duration-200 flex items-center justify-center">
                                    ...
                                    @if (!$image->is_main)
                                        <button onclick="setMainImage({{ $image->image_id }})"
                                                class="flex-1 cursor-pointer min-w-0 px-3 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-medium rounded-lg transition-colors duration-200 flex items-center justify-center">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button onclick="deleteImage({{ $image->image_id }})"
                                            class="px-3 cursor-pointerpy-2 bg-red-600 hover:bg-red-700 text-white text-xs font-medium rounded-lg transition-colors duration-200 flex items-center justify-center">

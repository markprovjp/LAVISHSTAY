    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Trang Sửa Câu hỏi</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Chỉnh sửa Câu hỏi thường gặp vào danh mục khách sạn của bạn</p>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <a href="{{ route('admin.faqs') }}" class="btn bg-gray-500 hover:bg-gray-600 text-white">
                    <i class="fa-solid fa-backward"></i><span class="ml-2">Trờ về danh sách</span>
                </a>
            </div>
        </div>
        <x-slot name="header">

<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div class=" space-x-3 ">
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tạo chính sách đặt cọc mới
                </h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Tạo một chính sách đặt cọc mới cho hệ thống đặt phòng
                </p>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <div class="px-6 py-8">
                <form action="{{ route('admin.deposit-policies.store') }}" method="POST" class="space-y-6"
                    ...
                    <!-- Policy Name -->
                    <div>
                        <label class="block text-sm font-medium mb-1" for="name">Tên chính sách <span
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Deposit Percentage -->
                        <div>
                            <label class="block text-sm font-medium mb-1" for="deposit_percentage">Phần trăm đặt cọc
                                (%)</label>
                            <input id="deposit_percentage" name="deposit_percentage"
                                class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 @error('deposit_percentage') border-red-500 @enderror"
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="deposit_fixed_amount_vnd">Số tiền cố định
                                (VND)</label>
                            <input id="deposit_fixed_amount_vnd" name="deposit_fixed_amount_vnd"
                                class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 @error('deposit_fixed_amount_vnd') border-red-500 @enderror"
                                type="number" min="0" step="1000"
                                value="{{ old('deposit_fixed_amount_vnd') }}" />
                    ...
                    @error('deposit_method')
                        <div
                            class="text-sm text-red-500 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3">
                            {{ $message }}
                        </div>
                    @enderror
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description"
                            ...
                            rows="4" placeholder="Mô tả chi tiết về chính sách đặt cọc...">{{ old('description') }}</textarea>
                    ...
                    <div
                        ...
                        <button type="submit" class="btn cursor-pointer bg-violet-500 hover:bg-violet-600 text-white">
                            <span class="button-text">Tạo chính sách</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Form found:', policyForm); // Debug log
            ...
            if (policyForm) {
                policyForm.addEventListener('submit', function(e) {
                    ...
                    if (submitBtn) {
                        ...
                        console.log('Button text element found:', buttonText); // Debug log
                        ...
                        `;
                            ...
                            setTimeout(() => {
                                ...
                                console.log('Button reset'); // Debug log
                            }, 10000);
                        }
                    }
                });
            } else {
                console.error('Form with id "policyForm" not found!');
            }

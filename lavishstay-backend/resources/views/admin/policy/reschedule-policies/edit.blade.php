    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Chỉnh sửa chính sách dời lịch</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Cập nhật thông tin chính sách dời lịch: {{ $policy->name }}</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <div class="px-6 py-8">
                <form action="{{ route('admin.reschedule-policies.update', $policy->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="Nhập mô tả cho chính sách dời lịch">{{ old('description', $policy->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="reschedule_fee_vnd" id="reschedule_fee_vnd" value="{{ old('reschedule_fee_vnd', $policy->reschedule_fee_vnd) }}" min="0"
                            ...
                            <div>
                                ...
                                <input type="number" name="reschedule_fee_percentage" id="reschedule_fee_percentage" value="{{ old('reschedule_fee_percentage', $policy->reschedule_fee_percentage) }}" min="0" max="100" step="0.01"
                            ...
                            <div>
                                ...
                                <input type="number" name="min_days_before_checkin" id="min_days_before_checkin" value="{{ old('min_days_before_checkin', $policy->min_days_before_checkin) }}" min="0"

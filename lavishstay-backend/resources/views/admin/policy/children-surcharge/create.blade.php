    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tạo chính sách phụ thu trẻ em</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Thêm mới chính sách phụ thu theo độ tuổi trẻ em</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <div class="px-6 py-8">
                <form action="{{ route('admin.children-surcharge.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="requires_extra_bed" 
                                           ...
                                           type="checkbox" 
                                           value="1"
                                           {{ old('requires_extra_bed') ? 'checked' : '' }}
                                           class="focus:ring-violet-500 h-4 w-4 text-violet-600 border-gray-300 dark:border-gray-600 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                    ...
                    <div id="surcharge_section" class="mb-8">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('surcharge_amount_vnd') }}"
                                   min="0"
                                   step="1000"

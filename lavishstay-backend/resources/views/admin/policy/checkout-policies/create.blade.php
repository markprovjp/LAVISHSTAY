    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div class=" space-x-3 ">
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tạo chính sách trả phòng mới</h1>
                ...
                <form action="{{ route('admin.checkout-policies.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="early_check_out_fee_vnd" name="early_check_out_fee_vnd" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 @error('early_check_out_fee_vnd') border-red-500 @enderror" type="number" min="0" step="1000" value="{{ old('early_check_out_fee_vnd') }}" />
                        ...
                        <div>
                            ...
                            <input id="late_check_out_fee_vnd" name="late_check_out_fee_vnd" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 @error('late_check_out_fee_vnd') border-red-500 @enderror" type="number" min="0" step="1000" value="{{ old('late_check_out_fee_vnd') }}" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 @error('description') border-red-500 @enderror" rows="4" placeholder="Mô tả chi tiết về chính sách trả phòng...">{{ old('description') }}</textarea>

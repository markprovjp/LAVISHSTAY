    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tạo chính sách gia hạn mới</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Thêm chính sách gia hạn mới cho hệ thống đặt phòng</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <div class="px-6 py-8">
                <form action="{{ route('admin.extend-policies.store') }}" method="POST" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="Nhập mô tả cho chính sách gia hạn">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_extension_days" id="max_extension_days" value="{{ old('max_extension_days') }}" required min="1"
                            ...
                            <div>
                                ...
                                <input type="number" name="min_days_before_checkout" id="min_days_before_checkout" value="{{ old('min_days_before_checkout') }}" min="0"
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="extension_fee_vnd" id="extension_fee_vnd" value="{{ old('extension_fee_vnd') }}" min="0"
                            ...
                            <div>
                                ...
                                <input type="number" name="extension_percentage" id="extension_percentage" value="{{ old('extension_percentage') }}" min="0" max="100" step="0.01"

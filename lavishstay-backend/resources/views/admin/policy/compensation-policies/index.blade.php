    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Quản Lý Chính Sách Bồi Thường
                </h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Quản lý tất cả các chính sách bồi thường và cấu hình
                    của chúng</p>
            </div>

            <!-- Right: Actions -->
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <!-- Add compensation policy button -->
                        ...
                        <form method="GET" action="{{ route('admin.compensation-policies') }}"
                            ...
                            <div class="flex-1">
                                <input type="text" name="search" value="{{ request('search') }}"
                                    ...
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-violet-500 dark:bg-gray-700 dark:text-gray-100">
                            </div>
                            <div>
                                <select name="status"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-violet-500 dark:bg-gray-700 dark:text-gray-100">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-violet-500 text-white rounded-md hover:bg-violet-600">Lọc</button>
                        </form>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @forelse($policies as $policy)
                                        <tr>
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $policy->condition_type_label }}
                                            </td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $policy->formatted_discount_value }}
                                            </td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $policy->roomType ? $policy->roomType->name : 'Tất cả' }}
                                            </td>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="space-y-2">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="flex flex-wrap gap-1 mt-1">
                                                                            <span
                                                                                ...
                                                                                {{ number_format($policy->max_compensation_amount, 0, ',', '.') }}
                                                                                VND
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="flex flex-wrap gap-1 mt-1">
                                                                        <span
                                                                            class="inline-flex items-center font-normal py-1 px-2 rounded-full text-xs bg-purple-100 dark:bg-purple-400/30 text-purple-600 dark:text-purple-400">
                                                                            {{ $policy->roomType ? $policy->roomType->name : 'Tất cả' }}
                                                                        </span>
                                                                    </div>
                                                                </div>

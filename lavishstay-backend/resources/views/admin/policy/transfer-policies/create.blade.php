    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Tạo chính sách chuyển phòng mới</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Thêm chính sách chuyển phòng mới cho hệ thống đặt phòng</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <div class="px-6 py-8">
                <form action="{{ route('admin.transfer-policies.store') }}" method="POST" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="Nhập mô tả cho chính sách chuyển phòng">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="transfer_fee_vnd" id="transfer_fee_vnd" value="{{ old('transfer_fee_vnd') }}" min="0"
                            ...
                            <div>
                                ...
                                <input type="number" name="transfer_fee_percentage" id="transfer_fee_percentage" value="{{ old('transfer_fee_percentage') }}" min="0" max="100" step="0.01"
                            ...
                            <div>
                                ...
                                <input type="number" name="min_days_before_check_in" id="min_days_before_check_in" value="{{ old('min_days_before_check_in') }}" min="0"
                            ...
                            <div class="flex items-center">
                                <label class="flex items-center">
                                    <input type="checkbox" name="requires_guest_confirmation" id="requires_guest_confirmation" value="1" {{ old('requires_guest_confirmation') ? 'checked' : '' }}

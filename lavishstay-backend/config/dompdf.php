...
return [
    ...
    */
     ...
     */
    // Disable entity conversion so multi-byte characters (e.g., Vietnamese, CJK)
    // are preserved and rendered by the selected font. Set to true only when
    // you need dompdf to convert special entities for legacy fonts.

...
class RequestReviewNotification extends Notification
{
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return [
            ...
            'message' => 'Cảm ơn bạn đã lưu trú — mã đặt phòng ' . ($bookingCode ?: ($bookingId ?? '')) . '. Vui lòng để lại đánh giá để giúp chúng tôi nâng cao dịch vụ.',
            'url' => '/review/' . ($bookingCode ?: ($bookingId ?? '')),
        ];
    }
}
